        ...
        <Box sx={style}>
          ...
          <Grid container mt={2} spacing={4}>
            <Grid item md={6} p={1}>
              <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                ...
                Ofreciéndole al automóvil respuesta inmediata, fuerza superior y
          ...
          <Box bgcolor="#ECF2F7" borderRadius="15px" p={3} position="relative">
            ...
            <Box display="flex">
              <CheckOutlinedIcon fontSize="small" />
              <Typography ml={1}>
                Garantía respaldada por procesos de fabricación certificados en
                ISO/TS16949.
              </Typography>
            </Box>
            <Box display="flex">
              <CheckOutlinedIcon fontSize="small" />
              <Typography ml={1}>
                Capacidades eléctricas superiores a los requerimientos de equipo
                original.
              </Typography>
            </Box>
            <Box display="flex">
            ...
            <Box display="flex">
              <CheckOutlinedIcon fontSize="small" />
              <Typography ml={1}>Más de 20 años en el mercado.</Typography>
            </Box>
            <Box display="flex">
              <CheckOutlinedIcon fontSize="small" />
